...
func TestDataConn(t *testing.T) {
	...
	t.Run("commit with order and rollback ok", func(t *testing.T) {
		...
		assert.Equal(t, log.Value, "SyncDataConn#OnTxnFailure 1")
		log = log.Next()
		assert.Equal(t, log.Value, "TxnFailureReport=[{DataConnName:bar DataConnType:*sabi.AsyncDataConn Cause:{State:NoneByCommitted Err:github.com/sttk/errs.Err {}} Rollback:{State:NoneByNotRolledBack Err:github.com/sttk/errs.Err {}}} {DataConnName:foo DataConnType:*sabi.SyncDataConn Cause:{State:NoneByUncommitted Err:github.com/sttk/errs.Err {}} Rollback:{State:NoneByNotRolledBack Err:github.com/sttk/errs.Err {}}} {DataConnName:qux DataConnType:*sabi.SyncDataConn Cause:{State:NoneByUncommitted Err:github.com/sttk/errs.Err {}} Rollback:{State:NoneByNotRolledBack Err:github.com/sttk/errs.Err {}}}]")
		log = log.Next()
	...
	t.Run("commit and rollback but fail second commit", func(t *testing.T) {
		...
		assert.Equal(t, log.Value, "SyncDataConn#OnTxnFailure 1")
		log = log.Next()
		assert.Equal(t, log.Value, "TxnFailureReport=[{DataConnName:foo DataConnType:*sabi.SyncDataConn Cause:{State:NoneByCommitted Err:github.com/sttk/errs.Err {}} Rollback:{State:NoneByRolledBack Err:github.com/sttk/errs.Err {}}} {DataConnName:bar DataConnType:*sabi.AsyncDataConn Cause:{State:CommitFailure Err:github.com/sttk/errs.Err {reason:YYY file:data-conn_test.go line:105}} Rollback:{State:NoneByNotRolledBack Err:github.com/sttk/errs.Err {}}}]")
		log = log.Next()
		assert.Equal(t, log.Value, "AsyncDataConn#OnTxnFailure 2")
		log = log.Next()
		assert.Equal(t, log.Value, "TxnFailureReport=[{DataConnName:foo DataConnType:*sabi.SyncDataConn Cause:{State:NoneByCommitted Err:github.com/sttk/errs.Err {}} Rollback:{State:NoneByRolledBack Err:github.com/sttk/errs.Err {}}} {DataConnName:bar DataConnType:*sabi.AsyncDataConn Cause:{State:CommitFailure Err:github.com/sttk/errs.Err {reason:YYY file:data-conn_test.go line:105}} Rollback:{State:NoneByNotRolledBack Err:github.com/sttk/errs.Err {}}}]")
